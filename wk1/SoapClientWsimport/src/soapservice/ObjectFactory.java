...
public class ObjectFactory {
    ...
    private final static QName _AddResponse_QNAME = new QName("http://soapservice/", "AddResponse");
    private final static QName _SubstractResponse_QNAME = new QName("http://soapservice/", "SubstractResponse");
    private final static QName _Add_QNAME = new QName("http://soapservice/", "Add");
    private final static QName _Substract_QNAME = new QName("http://soapservice/", "Substract");
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://soapservice/", name = "AddResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://soapservice/", name = "SubstractResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://soapservice/", name = "Add")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://soapservice/", name = "Substract")
