 ...
 * 
 */
@WebServiceClient(name = "SoapCalculatorService", targetNamespace = "http://soapservice/", wsdlLocation = "http://localhost:4321/WS/SoapCalculator?wsdl")
    ...
    extends Service
{
    ...
    private final static QName SOAPCALCULATORSERVICE_QNAME = new QName("http://soapservice/", "SoapCalculatorService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:4321/WS/SoapCalculator?wsdl");
    ...
    public Calculator getSoapCalculatorPort() {
        return super.getPort(new QName("http://soapservice/", "SoapCalculatorPort"), Calculator.class);
    }
     ...
     */
    @WebEndpoint(name = "SoapCalculatorPort")
    public Calculator getSoapCalculatorPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://soapservice/", "SoapCalculatorPort"), Calculator.class, features);
    }
